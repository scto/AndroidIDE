...
import com.itsaky.androidide.templates.base.baseAndroidPlugins
 ...
 * @param copyDefAssets Whether to copy the default Android assets (except
 *   `values` directory) to this module.
...
inline fun ProjectTemplateBuilder.defaultAppModule(
  ...
  check(defModuleTemplate == null) {
    "Default module has been already configured"
  }
