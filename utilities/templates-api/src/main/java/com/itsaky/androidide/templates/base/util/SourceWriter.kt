...
class SourceWriter {
  ...
  /**
   * The type of Java source. A [SourceType] creates a [TypeSpec.Builder] and
   * optionally pre-configures it.
   */
  ...
  fun ModuleTemplateBuilder.writeJavaSrc(
    ...
    executor.save(
      source,
      srcFilePath(srcSet, packageName, className, Language.Java),
    )
  }
  ...
  fun ModuleTemplateBuilder.writeKtSrc(
    ...
    executor.save(
      source,
      srcFilePath(srcSet, packageName, className, Language.Kotlin),
    )
  }
